...
export function buildPdf(report) {
  return new Promise((resolve, reject) => {
    try {
      ...
      const bullets = [
        "Medisinsk hjemmesykepleie er gratis i Norge. Egenandel på offentlig sykehjem beregnes av inntekt (75 % inntil 1G, 85 % over 1G), ikke av formue. 1G = 130 160 kr (2025).",
        "Pleieårene avhenger av oppgitt helse (god ≈ 3 år, middels ≈ 5 år, svekket ≈ 8 år).",
        "Privat hjelp hjemme er regnet til ca. 600 kr/t etter behov (4 / 12 / 40 t/uke). Privat institusjon ca. 75 000 kr/mnd (markedsanslag).",
        "Kostnadene er justert for region og ca. 3 % årlig prisvekst.",
        "Satser bygger på NAV (grunnbeløp), Lovdata/Helsedirektoratet (egenandelsforskrift 2025) og markedsanslag for private tjenester.",
      ];
      bullets.forEach((b) => {
        const y = doc.y;
